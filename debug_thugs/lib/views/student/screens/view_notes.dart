...
import 'package:debug_thugs/views/student/screens/notes_viewer.dart';
                            ...
                            child: Card(
                              child: ListTile(
                                trailing: IconButton(
                                  ...
                                  onPressed: () {
                                    openURL(Uri.parse(_searchResult[index]));
                                  },
                                ),
                                  ...
                                  child: Card(
                                    child: ListTile(
                                      trailing: IconButton(
                                        ...
                                        onPressed: () {
                                          openURL(Uri.parse(_notesList[index]
                                              .name));
                                        },
                                      ),
                                      leading: const Icon(
